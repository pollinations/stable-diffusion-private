...
cd ../model-index && python add_image.py pollinations/stable-diffusion-private 614871946825.dkr.ecr.us-east-1.amazonaws.com/pollinations/stable-diffusion-private && cd ..